...
export default async function RobotMissionsPage({ searchParams }: Props) {
  ...
  const missions = [
    { num: 1, title: t('missions.robot.m1_title'), desc: t('missions.robot.m1_desc'), progress: m1 },
    { num: 2, title: t('missions.robot.m2_title'), desc: t('missions.robot.m2_desc'), progress: m2 },
  ]
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {missions.map(m => (
          <MissionCard
            ...
            href={`/missions/robot?mission=${m.num}`}
            timeEstimate="15"
          />
        ))}
      </div>
