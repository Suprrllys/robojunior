...
import RobotMission1Wrapper from './RobotMission1Wrapper'
import RobotMission2Wrapper from './RobotMission2Wrapper'
import RobotMission3Wrapper from './RobotMission3Wrapper'
import RobotMission4Wrapper from './RobotMission4Wrapper'
import RobotMission5Wrapper from './RobotMission5Wrapper'
import RobotMission6Wrapper from './RobotMission6Wrapper'
import RobotMission7Wrapper from './RobotMission7Wrapper'
import RobotMission8Wrapper from './RobotMission8Wrapper'
import RobotMission9Wrapper from './RobotMission9Wrapper'
import RobotMission10Wrapper from './RobotMission10Wrapper'
...
export default async function RobotMissionsPage({ searchParams }: Props) {
  ...
  const missionNames: Record<number, string> = {
    1: t('missions.robot.m1.title'),
    2: t('missions.robot.m2.title'),
    3: t('missions.robot.m3.title'),
    4: t('missions.robot.m4.title'),
    5: t('missions.robot.m5.title'),
    6: t('missions.robot.m6.title'),
    7: t('missions.robot.m7.title'),
    8: t('missions.robot.m8.title'),
    9: t('missions.robot.m9.title'),
    10: t('missions.robot.m10.title'),
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-black text-white">{t('roles.robot_constructor.name')}</h1>
          <p className="text-gray-400">{t('roles.robot_constructor.skill')}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
        {Array.from({ length: TOTAL_MISSIONS }, (_, i) => {
          ...
          return (
            <Link
              key={num}
              href={`/missions/robot?mission=${num}`}
      ...
      {(() => {
        ...
        return activeMission === 1 ? (
          <RobotMission1Wrapper initialScore={initialScore} />
        ) : activeMission === 2 ? (
          <RobotMission2Wrapper initialScore={initialScore} />
        ) : activeMission === 3 ? (
          <RobotMission3Wrapper initialScore={initialScore} />
        ) : activeMission === 4 ? (
          <RobotMission4Wrapper initialScore={initialScore} />
        ) : activeMission === 5 ? (
          <RobotMission5Wrapper initialScore={initialScore} />
        ) : activeMission === 6 ? (
          <RobotMission6Wrapper initialScore={initialScore} />
        ) : activeMission === 7 ? (
          <RobotMission7Wrapper initialScore={initialScore} />
        ) : activeMission === 8 ? (
          <RobotMission8Wrapper initialScore={initialScore} />
        ) : activeMission === 9 ? (
          <RobotMission9Wrapper initialScore={initialScore} />
        ) : activeMission === 10 ? (
          <RobotMission10Wrapper initialScore={initialScore} />
        ) : (
